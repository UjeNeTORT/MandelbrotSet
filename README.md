# Эффективная визуализация множества Мандельброта
---
...
Асимптотическая оценка сложности: $O (width * height * n_{iterations})$ - достаточно медленно, чтобы картинка грузилась не сразу. \
...
- #### выбирается файл с тестовыми данными и измеряется разница в показаниях TSC до и после запуска функции для каждого тесткейса
...
***Оптимизации компилятора внесли ключевой вклад в ускорение программы, хотя без них использование SIMD инструкций все равно оправдано.***

# Использование программы и воспроизведение тестов
